    ...
    for dis in np.arange(1, n_dist + 1):
        ...
        for l in np.arange(1, total_l + 1):
            ...
            for p in perm:
                ...
                f.write(
                    "3.531   1.421     6.141         !! Peak1 position (positive density)\n"
                )
                f.write(
                    "0.313   0.103     0.523         !! Width of peak1 position (positive density)\n"
                )
                f.write(
                    "1.650   1.440     2.560         !! Peak2 position (positive density)\n"
                )
                f.write(
                ...
                f.write(
                    "0.196   0.080     0.450         !! Width of peak3 position (negative density)\n"
                )
                f.write(
                ...
                for dis in np.arange(1, dis + 1):
                    ...
                    f.write(
                        "40.4598   1.7678   80.1518    !! Outer (core+shell) radius of the sphere\n"
                    )
                    f.write(
                        "1.0000    1.0000    1.0000      !! Outer (shell) contrast of the sphere\n"
                    )
                    f.write(
                        "1.6920    0.1730   17.3839      !! Polydisperstiry on the sphere radius\n"
                    )
                    f.write(
                ...
                f.write(
                    "   0.01653    0.01323    0.1984    !! Polydisperstiry on the sphere radius\n"
                )
                f.write(
                    "  1.2278   1.2278   1.2278    !! Hard-sphere radius (for interactions only)\n"
                )
                f.write(
                    "2                                !! Schulz distribution 2 (Gauss distribution 1)\n"
                )
