...
parser = argparse.ArgumentParser(description='Script to  calculate number of possible permutations LIPMIX input file. Example: python calc_num_of_permutations.py -l 1 -d 1')
